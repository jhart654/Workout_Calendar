...
class Schedule(db.Model):
    ...
    def __init__(self,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,user_token, id = ''):
        self.id = self.set_id()
        self.Monday = Monday
    ...
    def __repr__(self):
        return f'The following have been added to the schedule: {self.name}'
